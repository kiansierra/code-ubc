...
def train_epoch(epoch:int, dataloader:DataLoader, model:BaseLightningModel, optimizer:Optimizer, scheduler:_LRScheduler, device):
    model.train()
...
def train_loop(train_dataloader:DataLoader, validation_dataloader:DataLoader, model:BaseLightningModel, config:DictConfig, device):
